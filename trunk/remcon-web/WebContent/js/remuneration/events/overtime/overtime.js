...
function commit() {
	...
	document.getElementById("frm")
		.setAttribute("action", contextPath + "/servlet/remuneration/events/overtime/EraseOvertime");
...
function cancel() {
	...
	document.getElementById("frm").setAttribute("action", contextPath + "/servlet/remuneration/events/overtime/OvertimeMain");
	document.getElementById("frm").submit();
    }
}
...
function buidInputs(row, isNew, lastDayMonth, overtimePercent, periodName) {
    ...
    cell.setAttribute("class", "cDataTD");
    cell.innerHTML = "<input type='text' id='percent' value='" + overtimePercent + "'>";
