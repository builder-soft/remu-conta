...
<h1 class="cTitle">Listado de Comprobantes Pendientes</h1>
...
<a class="cCancel" href="${pageContext.request.contextPath}/servlet/conta/voucher/VoucherManager">Cancelar</a>
