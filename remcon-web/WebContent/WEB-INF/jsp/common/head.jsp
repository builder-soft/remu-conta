...
<LINK rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/default.css?<%=Math.random() %>" />
<LINK rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/jdMenu.css?<%=Math.random() %>" />
...
<body marginwidth="25px" marginheight="5px" onload="javaScript:loadFormat();try{onLoadPage();}catch(e){}">
	<!-- 
loadFormat();
 -->
	...
	<div id="TOOLTIP_CONTENT" style="display: none; z-index: 2; position: absolute;" align="center">
		<br /> <br />
		<table border="0" style="background-color: white; border: #000000 solid" width="60%" height="50%">
			<tr>
				<td align="center" width="10">&nbsp;</td>
				<td>&nbsp;</td>
				<td align="center" width="10"><a class="cLabel" style="cursor: pointer" href="javascript:closeTooltip()"
					onmousemove="javascript:window.status='Cerrar'"> (X) </a></td>
			</tr>
			<tr>
				<td align="center" width="10">&nbsp;</td>
				<td height="90%" align="center" valign="top" id="TOOLTIP_CELL_CONTAINER"></td>
				<td align="center" width="10">&nbsp;</td>
			</tr>
			<tr>
				<td align="center" width="10">&nbsp;</td>
	...
	<table border="0" style="width: 100%">
		<tr>
			<td align="right"><span class="cLabel">Dominio:</span><span class="cData">&nbsp;<%=getDomainName(session)%></span>&nbsp;&nbsp;|&nbsp;&nbsp;
				<span class="cLabel">Usuario:</span><span class="cData">&nbsp;<%=getUserName(session)%> - <%=getUserMail(session)%></span></td>
		<tr>
